...
CUSTOM_VERSION := PixelExperience_go_$(CUSTOM_BUILD)-$(CUSTOM_PLATFORM_VERSION)-$(CUSTOM_BUILD_DATE)-CAF-$(CUSTOM_BUILD_TYPE)
ROM_FINGERPRINT := PixelExperience_go/$(CUSTOM_PLATFORM_VERSION)/$(TARGET_PRODUCT_SHORT)/CAF/$(CUSTOM_BUILD_DATE)
else
